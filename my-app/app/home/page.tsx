    ...
    <>
      <section className="header">
        ...
        <div className="text_box">
         <h2><Link href="/contact" >GET READY</Link></h2>  
          ...
          <p>
          A ONE YEAR AI PROGRAM DESIGNED FOR ABSOLUTE BEGINNERS. GETTING PAKISTAN READY FOR THE NEW ERA OF COMPUTING ENABLED BY THE RISE
      ...
      <section className="footer">
        ...
        <p>
          ...
          <a href="index.html">Ride Zainabi</a>
        </p>
        <p>
